#' @export
makeRLearner.classif.xgboost.custom = function() {
  makeRLearnerClassif(
...
#' @export
trainLearner.classif.xgboost.custom = function(.learner, .task, .subset, .weights = NULL,  ...) {
...
#' @export
predictLearner.classif.xgboost.custom = function(.learner, .model, .newdata, ...) {
  td = .model$task.desc
