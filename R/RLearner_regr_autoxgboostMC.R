#' @export
makeRLearner.regr.autoxgboostMC = function() {
  makeRLearnerRegr(
    cl = "regr.autoxgboostMC",
...
#' @export
trainLearner.regr.autoxgboostMC = function(.learner, .task, .subset, .weights = NULL,
  measure = list(mse), control = NULL, iterations = 160, time.budget = 3600, par.set = autoxgbparset, max.nrounds = 10^6, early.stopping.rounds = 10L,
...
#' @export
predictLearner.regr.autoxgboostMC = function(.learner, .model, .newdata, ...) {
