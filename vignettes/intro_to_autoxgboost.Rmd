...
```{r}
axgb$plot_parallel_coordinates(plotly = FALSE)
```
...
Set weight ranges for `parEGO`.

```{r}
axgb$plot_pareto_front_projections(wt_range = c(0, 0.1))
axgb$plot_pareto_front_projections(wt_range = c(0.1, 0.8))
axgb$plot_pareto_front_projections(wt_range = c(0.9, 1))
```
